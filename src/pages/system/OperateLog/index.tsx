...
import type {OperateLogListParam, OperateLogVo} from './data';
...
const OperateLog: React.FC = () => {
    ...
    const queryDataList = (params: OperateLogListParam) => {
        queryOperateLogList(params).then(res => {
            if (res.code === 0) {
                setTotal(res.total)
                setOperateLogListData(res.data)
            } else {
